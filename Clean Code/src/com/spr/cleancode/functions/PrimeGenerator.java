package com.spr.cleancode.functions;
...
public class PrimeGenerator {
    ...
    private static void crossOutMultiples() {
        final int limit = determineIterationLimit();
    ...
    private static int determineIterationLimit() {
        ...
        final double iterationLimit = Math.sqrt(crossedOut.length);
    ...
    public static void main(final String[] args) {
        final int[] prime = generatePrimes(100);
        for (final int i : prime) {
